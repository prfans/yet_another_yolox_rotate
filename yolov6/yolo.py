...
from yolov6.efficientrep import EfficientRep
from yolov6.reppan import RepPANNeck
from yolov6.effidehead import Detect, build_effidehead_layer
...
def build_model(cfg, num_classes):
    model = Model(cfg, channels=3, num_classes=num_classes, anchors=cfg.model.head.anchors)
    return model
